function ListOfComments() {
	...
	{
		document.write("<div id=\"commentForm"+_instanceVarStr+"\" style=\"border:solid; border-width:1px; width:300px;\" ><span style=\"font-weight:bold; font-size:18px;\" >Input Text</span><br />");
		document.write("<form>");
	...
	this.addNewComment = function(_elmName, _elmContent, _elmNewComment, _instanceVarStr) 
	{
		...
		var newCommentForm1 = "<span style=\"font-weight:bold; font-size:18px;\" >Input Text:</span><br /><form>";
		var newCommentForm2 = "Username <input type=\"text\" id=\"nameInput"+_instanceVarStr+"\" /><br />";
