...
INSERT INTO `categories` VALUES (1,'Intelegensi buatan','2013-03-07 06:46:36'),(2,'Progin','2013-03-12 10:00:00'),(3,'IMK','2013-03-14 00:26:14'),(4,'SIster','2013-03-14 00:41:42'),(5,'Benny','2013-03-14 01:17:38');
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`idtugas`) REFERENCES `tugas` (`id`),
...
INSERT INTO `users` VALUES ('edogawa','edward_samuel_esp@yahoo.com','19b13f6bbc0d19a5dba84b209a22a487','Edward Samuel','1991-12-16','edogawa.jpg'),('edwardsp','edward_samuel_esp@hotmail.com','9aa6e5f2256c17d2d430b100032b997c','Edward Samuel Pasaribu','1992-07-16','edwardsp.jpg');
