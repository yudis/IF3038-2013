...
--
-- Host: localhost
-- Generation Time: Mar 20, 2013 at 10:19 AM
...
ALTER TABLE `assignees`
  ADD CONSTRAINT `assignees_ibfk_1` FOREIGN KEY (`id_tugas`) REFERENCES `tugas` (`id`),
  ADD CONSTRAINT `assignees_ibfk_2` FOREIGN KEY (`username`) REFERENCES `users` (`username`);
