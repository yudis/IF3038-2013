...
<%!
    public void doPaging(JspWriter out, ResultSet resultSet, String sqlQuery, String term, String type, int limit)
    {
        ...
        try
        {
            if (resultSet.next()) 
            {
                ...
                int pageamount = (int) Math.ceil(count / 10.0d);
            ...
            if (type.equals("semua")) 
            {
                ...
                <div class="clearall container">
                    ...
                    <% 
                        ...
                        doPaging(out, resultSet, sqlQuery, term, type, limit);
