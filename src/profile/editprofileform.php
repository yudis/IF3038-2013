		...
		<div class="clearall container" id="registerform">
			...
			<fieldset>
				<p>
					...
					<input value="<?=$_GET['fullname'];?>" id="fullname"
				...
				<p>
					...
					<input value="<?=$_GET['password'];?>" id="password" onchange="checkPassword()"
					required="required" aria-required="true"
					pattern="^[- \w\d\u00c0-\u024f]{8,}$"
					title="Your password"
				...
				<p>
					...
					<input value="<?=$_GET['password'];?>"  id="confirmpassword" onchange="checkConfirmPassword()"
					required="required" aria-required="true"
					pattern="^[- \w\d\u00c0-\u024f]{8,}$"
				...
				<p>
					...
					<input value="<?=$_GET['dob'];?>"  id="dob" onchange="checkDOB()"
					required="required" aria-required="true"
				...
				<div class='box' id="avatar">
					<img src='<?="../images/".$_GET['photo'];?>' width='200' height='200'></h3>
				</div>
