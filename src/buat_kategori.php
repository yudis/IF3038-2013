<?php
	...
	$query2 = "INSERT INTO asignee_has_kategori (accounts_idaccounts, kategori_idkategori) VALUES(".$_POST["pembuat"].",(SELECT idkategori from kategori where nama = '".$_POST["catname"]."' and pembuat = ".$_POST["pembuat"]."))";
