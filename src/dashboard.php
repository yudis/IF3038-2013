                ...
                <div id="listTugas" class="main">
                    <?php
						...
						if ($kategori == "all") {
							...
							$sqlcat="SELECT DISTINCT category_name, category_id FROM category, task, task_incharge WHERE category.category_id = task.task_category AND task.task_id = task_incharge.task_id AND task_incharge.people_incharge_task = '".$username."'";
							...
							while ($row = mysql_fetch_array($result)) {
								...
								while ($row2 = mysql_fetch_array($result2)) {
									...
									echo("<div><a href='tugas.php?id=".$row2["task_id"]."'>".$row2["task_name"]."</a></div>
