...
mysql_query("INSERT INTO tugas (idtugas, namatugas, attachment, deadline, idkategori, username, status) VALUES ('$idtugas', '$namatugas', '$attachment', '$deadline', '$idkategori', '$username', '')");

for ($i=0; $i < count($tag); $i++) 
	mysql_query("INSERT INTO tag (idtugas, isitag) VALUES ('$idtugas', '$tag[$i]')");
	for ($j=0; $j < count($assignee); $j++) 
	mysql_query("INSERT INTO assignee (username, idtugas) VALUES ('$assignee[$i]', '$idtugas')");
