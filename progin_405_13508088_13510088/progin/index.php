...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            <div class="body">
				...
				<header><a href="index.php"><img src="images/Logo.png"></a></header>
				<div id="loginform">
				...
				<form name="register"  method="post" accept-charset="utf-8" onsubmit="reg" action="register.php"> 
						<p>
				        ...
				        <input type="fullname" name="fullname" placeholder="Nama anda" required> 
			...
			<select name="tahunbirthday">
				...
				<option value="2008" >2008</option>
					 ...
					 <br /> 
					  <input name = "avatar" type="file" placeholder="" required> 
						<br />
