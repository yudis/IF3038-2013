...
CREATE SCHEMA IF NOT EXISTS `progin_405_13510047` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `progin` ;
...
CREATE  TABLE IF NOT EXISTS `progin`.`kategori` (
  ...
  PRIMARY KEY (`idkategori`, `pembuat`) ,
...
-- -----------------------------------------------------
-- Table `progin`.`asignee_has_kategori`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `progin`.`asignee_has_kategori` (
  `accounts_idaccounts` INT NOT NULL ,
  `kategori_idkategori` INT NOT NULL ,
  PRIMARY KEY (`accounts_idaccounts`, `kategori_idkategori`) ,
