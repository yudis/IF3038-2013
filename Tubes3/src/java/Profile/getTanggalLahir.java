 ...
 */
@WebServlet(name = "getTanggalLahir", urlPatterns = {"/getTanggalLahir"})
public class getTanggalLahir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (result.next()) {
                ...
                out.println("<div>"+result.getString("tanggal_lahir")+"</div>");                
                out.println("</div>");
            }
