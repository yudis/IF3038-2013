 ...
 */
@WebServlet(name = "getAvatar", urlPatterns = {"/getAvatar"})
public class getAvatar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (result.next()) {
                out.println("<div id=\"avatarnya\">");
                out.println("<div>"+ "<img width=\"200px\" height=\"200px\" src=\""+result.getString("username")+"\">"+"</div>");                
                out.println("</div>");
            }
