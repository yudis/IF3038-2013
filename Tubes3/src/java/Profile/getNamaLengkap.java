 ...
 */
@WebServlet(name = "getNamaLengkap", urlPatterns = {"/getNamaLengkap"})
public class getNamaLengkap extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (result.next()) {
                out.println("<div id=\"namalengkap\">");
                out.println("<div>"+result.getString("nama_lengkap")+"</div>");                
                out.println("</div>");
            }
