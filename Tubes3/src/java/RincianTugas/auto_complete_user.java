 ...
 * @author Christianto
 */
@WebServlet(name = "auto_complete_user", urlPatterns = {"/auto_complete_user"})
public class auto_complete_user extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result.next()) {
                ...
                //out.print("Tidak ada user dengan nama itu"+"\n");
            }
