...
public class getCat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet result = query.executeQuery("SELECT * FROM kategori");
            
            while (result.next()) {
                out.println("<div id=\"categ\" onclick=\"showAddTask();catTask("+result.getInt("id_kategori")+");\">");
                out.println("<div>"+result.getString("nama_kategori")+"</div>");
                out.println("</div>");
            }
