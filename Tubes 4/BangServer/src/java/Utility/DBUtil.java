...
public class DBUtil {
    ...
    public static Connection getConnection() {
        if (connection != null) {
            ...
            try {
                String VCAP_SERVICES = "{\"mysql-5.1\":[{\"name\":\"progin\",\"label\":\"mysql-5.1\",\"plan\":\"free\",\"tags\":[\"mysql\",\"mysql-5.1\",\"relational\",\"mysql-5.1\",\"mysql\"],\"credentials\":{\"name\":\"progin\",\"hostname\":\"localhost\",\"host\":\"localhost\",\"port\":3306,\"user\":\"root\",\"username\":\"root\",\"password\":\"\"}}]}";
