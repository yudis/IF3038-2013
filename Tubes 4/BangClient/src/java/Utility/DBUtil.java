...
public class DBUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            String VCAP_SERVICES = "{\"mysql-5.1\":[{\"name\":\"progin\",\"label\":\"mysql-5.1\",\"plan\":\"free\",\"tags\":[\"mysql\",\"mysql-5.1\",\"relational\",\"mysql-5.1\",\"mysql\"],\"credentials\":{\"name\":\"test\",\"hostname\":\"localhost\",\"host\":\"localhost\",\"port\":3306,\"user\":\"progin\",\"username\":\"progin\",\"password\":\"progin\"}}]}";
