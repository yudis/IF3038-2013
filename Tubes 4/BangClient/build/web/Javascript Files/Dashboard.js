...
function addTask() {
    console.log("Add Task Javascript");
    var deadline = document.getElementById("newTaskDeadline").value;
    var name = document.getElementById("newTaskName").value;
    var assignees = document.getElementById("newTaskAssignees").value;
    var tags = document.getElementById("newTaskTags").value;
    var xmlhttp;
    var url = "BangServlet?action=addTask&name=" + name + "&deadline=" + deadline + "&assignees=" + assignees + "&tags=" + tags;
