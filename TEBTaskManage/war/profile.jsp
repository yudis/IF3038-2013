                ...
                <div id="unfinished-task">
                        ...
                        <div>
                                ...
                                <% 
                                    ...
                                    Query q = pm.newQuery("SELECT taskid FROM " + Assignee.class.getName() + " WHERE username='"+usernameToShow+"'");
                                    List<Integer> rs = (List<Integer>) q.execute();
                                    Iterator<Integer> iter = rs.iterator();
                                    while(iter.hasNext()){
                                        HashMap<String,String> task = func.GetTask(String.valueOf(iter.next().intValue()));
                                        if (task != null){
                ...
                <div id="finished-task">
                        ...
                        <div>
                                ...
                                <% 
                                    ...
                                    q = pm.newQuery("SELECT taskid FROM " + Assignee.class.getName() + " WHERE username='"+usernameToShow+"'");
                                	rs = (List<Integer>) q.execute();
                                	Iterator<Integer> iter2 = rs.iterator();
                                    while(iter2.hasNext()){
                                        HashMap<String,String> task = func.GetTask(String.valueOf(iter2.next().intValue()));
                                        if (task != null){
