...
public class listkategori extends HttpServlet {
    ...
    protected void doPost(
        ...
        HttpServletResponse response
			...
			query = "SELECT category_name, category.category_id FROM category, task, task_incharge WHERE category.category_id = task.task_category AND task.task_id = task_incharge.task_id AND task_incharge.people_incharge_task = '"+uname+"' GROUP BY category_name";
