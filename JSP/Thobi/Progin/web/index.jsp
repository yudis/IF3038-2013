        ...
        <div class="page">
            <header class="content">
                <nav>
                    ...
                    <div id="loginwrapper">
                        <form name="login"  onsubmit="return loginCheck();" method="post" action="dashboard.jsp">
                ...
                <div id="rightcolumn">
                    <div id="registerwrapper">
                        ...
                        <form name="registration" onsubmit="return registerCheck();" enctype="multipart/form-data" method="post" action="adduser.php">
                            ...
                            <div class="wrapper">
                                <input type="text" class="regbox" id="bday" name="bday" required="required" placeholder="Birthday (dd-mm-yyyy)" onkeyup="validateBday();" onchange="validateBday();" onclick="return validateBday();"/><a href="#" onclick="return bdayPicker();"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
                            </div>
                            <div class="wrapper">
