...
function setCommentCount()
{
	...
	xmlhttp.open("GET","getcommentinfo?id="+IDTugas+"&type=1",true);
	xmlhttp.send();
}
...
function getTaskName(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=taskname&id="+id,true);
	xmlhttp.send();
}
...
function getStatus(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=status&id="+id,true);
	xmlhttp.send();
}
...
function getDeadline(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=deadline&id="+id,true);
	xmlhttp.send();
}
...
function setAttachment(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=attach&id="+id,true);
	xmlhttp.send();
}
...
function setAssignee(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=assignee&id="+id,true);
	xmlhttp.send();
}
...
function setTags(id)
{
	...
	xmlhttp.open("GET","gettaskinfo?type=tag&id="+id,true);
	xmlhttp.send();
}
...
function addKomentar() {
	...
	xmlhttp.open("GET","addcomment?id="+id_komentar+"&user="+username+"&date="+date+"&tugas="+IDTugas+"&comment="+comment,true);
	xmlhttp.send();
...
function deletekomentar(comment_id)
{
	...
	xmlhttp.open("GET","deletecomment?id="+comment_id,true);
	xmlhttp.send();
...
function saveToDatabase()
{
	...
	xmlhttp.open("GET","settaskinfo?id="+id+"&status="+stringStatus+"&deadline="+stringDate+"&assignee="+stringAssignee+"&tags="+stringTags,true);
	xmlhttp.send();
}
