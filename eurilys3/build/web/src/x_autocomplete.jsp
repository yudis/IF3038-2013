...
<%  
    ...
    if (hint.length() > 0) {
        for (int i=0; i<idList.size(); i++) {
            if (buffer.equals("")) {
                buffer = "<div class='search_recommend' id='addtask_ass_"+idList.get(i)+"' onclick=\"javascript:addXTaskAssigne('"+idList.get(i)+"');\">"+idList.get(i)+"</div>";
            }
            else {
                buffer = buffer + "<br> <div class='search_recommend' id='addtask_ass_"+idList.get(i)+"' onclick=\"javascript:addXTaskAssigne('"+idList.get(i)+"');\">"+idList.get(i)+"</div>";
            }
        }
    }
