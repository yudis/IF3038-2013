...
function ubah_detail_user(usernamelama){
    ...
    var avatar = document.getElementById("aavatar_upload").value;
    ...
    {// code for IE6, IE5
     ...
     xmlhttp.onreadystatechange=function()
      ...
      xmlhttp.open("GET","../php/ubahtask.php?umd="+usernamelama+"&un="+username+"&av="+avatar+"&p="+password+"&f="+fullname+"&e="+email,true);
      xmlhttp.send(); 
