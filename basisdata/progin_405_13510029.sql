...
--
-- Host: localhost
-- Generation Time: Mar 23, 2013 at 01:53 PM
...
('1', 'Tugas Progin', 0, '2013-03-23', '1'),
('2', 'Tugas Kripto', 0, '2013-03-23', '2');
...
--
-- Table structure for table `task_creator`
--

CREATE TABLE IF NOT EXISTS `task_creator` (
  `task_id` varchar(255) NOT NULL,
...
--
-- Dumping data for table `task_creator`
--
...
--
-- Constraints for table `task_creator`
--
ALTER TABLE `task_creator`
  ADD CONSTRAINT `task_creator_ibfk_2` FOREIGN KEY (`creator`) REFERENCES `user` (`username`) ON DELETE CASCADE,
  ADD CONSTRAINT `task_creator_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `task` (`task_id`) ON DELETE CASCADE;
