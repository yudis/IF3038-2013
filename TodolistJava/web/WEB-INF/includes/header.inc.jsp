    ...
    <body <c:out value="${bodyAttrs}" default="" escapeXml="false" />>        <div class="page">
            <header class="content">
                ...
                <div class="welcomebar">
                    ...
                    <a href="./profile.jsp"><img src="./images/avatars/<%= _currentUser.getAvatar() %>" alt="<%= _currentUser.getFullName()%>" width="32" height="32" /></a> Hi <strong><%= _currentUser.getFullName()%></strong> (<a href="./profile.php"><%= _currentUser.getUsername() %></a>)
                    </div>
            </header>
            <div class ="content">