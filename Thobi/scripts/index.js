...
var isValidUname = false, isValidPassword = false, isValidRePassword = false, isValidFullName = false, isValidEmail = false, isValidBday = false, isValidPhoto = false, isValidLogin = false, isValidRegist = false;
...
function validateLogin() {
	...
	xmlhttp.open("GET","login.php?uname="+xUsername+"&pwd="+xPassword,true);
