...
function deleteTaskRedirect(idtask){
   var xmlhttp;
   if (window.XMLHttpRequest)
   {// code for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp=new XMLHttpRequest();
...
function autoCompleteAddCat(str){
   
   var suggestion = document.getElementById("addCategory_suggestion");
   
   if (str.indexOf(",") != -1){
      str = str.substring(str.lastIndexOf(",")+1);
      str = str.trim();
   }
   str+="&username=1&category=0&task=0";
...
function autoCompleteAddTask(str){
   
   var suggestion = document.getElementById("addTask_suggestion");
