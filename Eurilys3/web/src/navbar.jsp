   ...
   <div id="category_list">
      ...
      <div id="category_form">
         <div id="category_form_inner">	
            ...
            <br><br>
            Assignee(s) : <br>
            <input type="text" list="addCategory_suggestion" id="add_category_asignee_name" onkeyup="autoCompleteAddCat(this.value)">
            <datalist id="addCategory_suggestion"></datalist>
            <br><br>
