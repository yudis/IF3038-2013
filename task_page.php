...
<html>
			...
			<div id="task-page-body">
				...
				<div id="attachment">
					...
					<div id="image-attachment">
						...
						<br>
						<br>
							<img id="screenshots" src="images.jpg">
							<img id="screenshots" src="images1.jpg">
							<img id="screenshots" src="images2.jpg">
							<img id="screenshots" src="images3.jpg">
						</div>
					</div>
				...
				<div id="user-comment">
					...
					<div id="comment-list">
						<div id="comment">
							<div id="user-info">
								<div id="left-comment-body">
									<img src="bian.jpg" width="50px" height="50px"/>
								</div>
						...
						<div id="comment">
							<div id="user-info">
								<div id="left-comment-body">
									<img src="fadhil.jpg" width="50px" height="50px"/>
								</div>
								<div id="right-comment-body">
	...
	<script>
			function myFunction(e)
			{
				...
				if (name!=null)
				{
					x="<div id=comment><div id=user-info><div id=left-comment-body><img src=ecky.jpg width=50px height=50px"+
