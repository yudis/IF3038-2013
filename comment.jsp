...
try
{
	...
	int member = Integer.parseInt(request.getParameter("id"));
	...
	PreparedStatement pst1 = con.prepareStatement("INSERT INTO `comments` (member, task, timestamp, comment) VALUES (?, ?, ?, ?)");
	pst1.setInt(1, member);
	pst1.setInt(2, task);
	pst1.setString(3, timestamp);
	pst1.setString(4, komentar);
	pst1.executeUpdate();
	pst1.close();
