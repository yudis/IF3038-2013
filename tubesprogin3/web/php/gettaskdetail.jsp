...
<%
   ...
   try{
    ...
    String QueryStr = "SELECT cat_task_name,task_name,task_status,task_deadline,task_tag_multivalue,checkbox,assignee_name,file FROM task WHERE task_name='"+namatask+"'";
