...
function newtaskdetail(idlast){
    ...
    {// code for IE6, IE5
                 ...
                 // $('#dynamic_content-of-div').empty();
                   var response = xmlhttp.responseText;
                    if (response !==""){
                      ...
                      window.location.href= "../src/taskdetail_file.jsp?ct="+result[0]['cat_task_name']+"&tm="+result[0]['task_name']+"&ts="+result[0]['task_status']+"&td="+result[0]['task_deadline']+"&ttm="+result[0]['task_tag_multivalue']+"&c="+result[0]['checkbox'];               
                    }else{
     ...
     xmlhttp.open("GET","../php/getnewtaskdetail.jsp?t="+idlast,true);
     xmlhttp.send();
     ...
     xmlhttp.onreadystatechange=function()
      {
        if (xmlhttp.readyState==4 && xmlhttp.status==200)
        {
                    ...
                    if (response !==""){
                      ...
                      window.location.href= "../src/getnewtaskdetail.jsp?id="+result.last_idx;               
                    }else{
      ...
      xmlhttp.open("GET","../php/tambahtask.jsp?t="+task_name+"&a="+attachment+"&d="+deadline+"&as="+assignee+"&tag="+tag,true);
      xmlhttp.send();
