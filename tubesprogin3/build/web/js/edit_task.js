function check_value(namatask,kategori){
    ...
    {// code for IE6, IE5
     ...
     xmlhttp.onreadystatechange=function()
      ...
      xmlhttp.open("GET","../php/getcheckboxvalue.jsp?namatask="+namatask,true);
      xmlhttp.send();
...
function changevalue(value,namatask,kategori){
    ...
    {// code for IE6, IE5
     ...
     xmlhttp.onreadystatechange=function()
      ...
      xmlhttp.open("GET","../php/changestatusncheckbox.jsp?t="+value+"&nama="+namatask,true);
      xmlhttp.send();   
...
function tampil_edit_task(namatask){
    ...
    {// code for IE6, IE5
     ...
     xmlhttp.open("GET","../php/gettaskdetail.jsp?t="+namatask,true);
     xmlhttp.send();    
