...
<body onLoad="SlideShow()">
	<section>
		<div id="content" class="wrap">
			...
			<div id="login">
				<form id="form" class="form" action= "LoginServlet">
					<p>
						<label for="login">Username</label>
						<input id="idlogin" type="text" name="username" placeholder="Username">
					</p>
					<p>
			...
			<div id="register">
                            <form id="daftar" class="daftar" method="POST" action= "RegisterServlet" >
				<p>
				...
				<div>
					...
					<select id="tahun" name="tahun" onchange="cekulta();">
						<option></option>
						<option>1955</option>
						<option>1956</option>
						<option>1957</option>
					...
					<select id="bulan" name="bulan" onchange="cekulta();">
						<option></option>
					...
					<select id="tanggal" name="tanggal" onchange="cekulta();">
						<option></option>
						<option value = "1">1</option>
						<option value = "2">2</option>
						<option value = "3">3</option>
